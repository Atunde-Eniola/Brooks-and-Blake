...
const TopStories = ({posts}) => {         
  ...
  return (
    <div className='bg-white w-full'>
     ...
     <div className="bg-white   text-gray-800 subpixel-antialiased   md:flex md:gap-4  pt-4">
       ...
       {posts.slice(0,3).map((item,index)=>{
         ...
         return(
        <div key={index} className='flex  flex-1 flex-col mb-4 '>
       <Image src={jetpack_featured_media_url } alt='' width={300} height={200} className='object-cover rounded-xl '/>

       <h3 className='text-[1rem]  font-bold leading-4  my-3 px-6'>
         <Link href={{
            pathname: '/about',
            query: { id: item.id },
          }}>
